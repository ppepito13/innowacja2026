            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 text-gray-300 text-lg mb-6">
                <div className="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" style={{ color: event.brandingHexColor }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <section>
            <div className="bg-gray-800/80 rounded-2xl p-8 shadow-xl border border-gray-700/50 sticky top-8">
              ...
              <form className="flex flex-col gap-5">
                ...
                <div className="flex items-start gap-3 mt-2">
                  <div className="flex items-center h-5">
                    <input
                      id="consent"
                      type="checkbox"
                      className="w-4 h-4 rounded bg-gray-900 border-gray-700 focus:ring-offset-gray-800"
                      style={{ accentColor: event.brandingHexColor }}
                    />
                  </div>
                ...
                <button
                  type="button"
                  className="w-full mt-4 py-3 px-4 rounded-lg text-white font-bold text-lg transition-transform hover:scale-[1.02] active:scale-[0.98] shadow-lg"
